...
```{r e2-wppl-plot, fig.align = "center", fig.height = 4, fig.width = 6.46, fig.cap = "Participants' prevalence judgments from Experiment 1, compared to model predictions (horizontal lines)."}
