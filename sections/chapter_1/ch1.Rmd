...
```{r distribution-plot, fig.height = 5.5, fig.width=3.4, fig.align = "center", num.cols.cap=1, fig.cap = "Density plots showing usage at each timepoint based on the typicality of the adjective-noun pair.", fig.pos="tb"}
...
```{r prototypical-plot, fig.width=3.6, fig.align = "center", num.cols.cap=1, fig.cap = "Proportion of caregiver description that is about typically-true features, as a function of age."}
