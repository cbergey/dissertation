...
```{r child = "proposal_sections/chapter_1/ch1.Rmd"}
```

# Chapter 2: How adults use contrastive inference to learn about new categories

```{r child = "proposal_sections/chapter_2/experiment2.Rmd"}
```

```{r child = "proposal_sections/chapter_2/experiment3.Rmd"}
```
...
```{r child = "proposal_sections/chapter_3/ch3.Rmd"}
```
